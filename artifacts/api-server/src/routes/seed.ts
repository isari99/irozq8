...
const QUESTIONS = [
  ...
  // ─── ذكاء – ألغاز جديدة ──────────────────────────────────────────────────
  { text: "شيء تملكه أنت، ولكن يستخدمه الآخرون أكثر منك.. فما هو؟", choices: ["مفتاح منزلك", "رقم هاتفك", "اسمك", "محفظتك"], correctAnswer: 3, category: "ذكاء" },
  { text: "ما هو الشيء الذي له مدن بلا بيوت، وجبال بلا شجر، وبحار بلا سمك؟", choices: ["التلفاز", "الخريطة", "الحلم", "الكتاب"], correctAnswer: 2, category: "ذكاء" },
  { text: "أنا طويل حين أكون شاباً، وقصير حين أكون عجوزاً، وأضيء للناس.. من أنا؟", choices: ["المصباح", "الطريق", "الشمعة", "القلم"], correctAnswer: 3, category: "ذكاء" },
  { text: "إذا كان هناك 3 تفاحات، وأخذتَ أنتَ منها تفاحتين.. فكم تفاحة معك الآن؟", choices: ["واحدة", "اثنتان", "ثلاث", "لا شيء"], correctAnswer: 2, category: "ذكاء" },
  { text: "ما هو الشيء الذي يمتلئ بالثقوب ومع ذلك يحفظ الماء؟", choices: ["المصفاة", "المنخل", "الإسفنج", "الكأس"], correctAnswer: 3, category: "ذكاء" },
  { text: "ما هو الشيء الذي يتقدم ولا يعود أبداً؟", choices: ["القطار", "العمر", "الماء", "الشمس"], correctAnswer: 2, category: "ذكاء" },
  { text: "ما هو الشيء الذي ينبض بلا قلب؟", choices: ["البحر", "الساعة", "الجبل", "العصفور"], correctAnswer: 2, category: "ذكاء" },
  { text: "شيء إذا أكلت نصفه تموت، وإذا أكلته كله لا يحدث شيء؟", choices: ["الأرز", "السمسم", "التمر", "التفاح"], correctAnswer: 2, category: "ذكاء" },
  { text: "له إبهام وأربعة أصابع وليس به لحم أو عظم؟", choices: ["الهيكل العظمي", "القفاز", "الظل", "الصورة"], correctAnswer: 2, category: "ذكاء" },
  { text: "شهر إذا حذفت أوله أصبح اسم فاكهة؟", choices: ["يناير", "تموز", "أبريل", "سبتمبر"], correctAnswer: 2, category: "ذكاء" },
  { text: "ما الشيء الذي يدور حول البيت دون أن يتحرك؟", choices: ["الهواء", "الجدار", "الطريق", "السيارة"], correctAnswer: 2, category: "ذكاء" },
  { text: "ما الشيء الذي له أرجل ولا يمشي؟", choices: ["الطاولة", "الكرسي", "كل ما سبق", "السرير"], correctAnswer: 3, category: "ذكاء" },
  { text: "ما الشيء الذي لا يتكلم وإذا جاع كذب؟", choices: ["الطفل", "الساعة", "الراديو", "الببغاء"], correctAnswer: 2, category: "ذكاء" },
  { text: "ابن أمك وابن أبيك وليس بأخيك فمن هو؟", choices: ["عمك", "خالك", "أنت", "جارك"], correctAnswer: 3, category: "ذكاء" },
  { text: "ما الشيء الذي يحمل طعامه فوق رأسه؟", choices: ["النملة", "قلم الرصاص", "الشمعة", "المدخنة"], correctAnswer: 2, category: "ذكاء" },
  { text: "ما هو أضعف بيت في الأرض؟", choices: ["بيت النمل", "بيت العنكبوت", "بيت النحل", "بيت الورق"], correctAnswer: 2, category: "ذكاء" },

  // ─── سرعة بديهة – جديد ──────────────────────────────────────────────────
  { text: "عائلة مكونة من 6 بنات وأخ لكل منهن، كم عدد الأبناء فقط؟", choices: ["12", "7", "6", "8"], correctAnswer: 2, category: "سرعة بديهة" },

  // ─── حيوانات – جديد ─────────────────────────────────────────────────────
  { text: "ما هو الحيوان الذي لا يصدر أي صوت إطلاقاً؟", choices: ["الأرنب", "الزرافة", "الحوت", "النمل"], correctAnswer: 2, category: "حيوانات" },
  { text: "أين يقع قلب الروبيان (الجمبري)؟", choices: ["في ذيله", "في رأسه", "في بطنه", "ليس له قلب"], correctAnswer: 2, category: "حيوانات" },
  { text: "كم عدد القلوب التي يمتلكها الأخطبوط؟", choices: ["قلب واحد", "قلبان", "3 قلوب", "4 قلوب"], correctAnswer: 3, category: "حيوانات" },
  { text: "أي من هذه الكائنات يمكنه إعادة إنتاج أطرافه المفقودة بالكامل؟", choices: ["الضفدع", "نجم البحر", "الثعبان", "السنجاب"], correctAnswer: 2, category: "حيوانات" },
  { text: "ما هو لون حليب فرس النهر؟", choices: ["أبيض", "أصفر", "وردي", "شفاف"], correctAnswer: 3, category: "حيوانات" },
  { text: "كم عدد عيون الذبابة الواحدة تقريباً؟", choices: ["2", "100", "4000", "10"], correctAnswer: 3, category: "حيوانات" },
  { text: "ما هو الحيوان الذي ينام وعينه مفتوحة؟", choices: ["الأسد", "الدلفين", "البومة", "التمساح"], correctAnswer: 2, category: "حيوانات" },

  // ─── علوم – جديد ─────────────────────────────────────────────────────────
  { text: "ما هو العضو الوحيد في جسم الإنسان الذي لا يصله الدم؟", choices: ["الأظافر", "قرنية العين", "طبلة الأذن", "الشعر"], correctAnswer: 2, category: "علوم" },
  { text: "ما هو المعدن الذي يكون في حالة سائلة في درجة حرارة الغرفة؟", choices: ["الحديد", "الزئبق", "القصدير", "النحاس"], correctAnswer: 2, category: "علوم" },
  { text: "ما هو الشيء الذي يغلي إذا تجمد؟", choices: ["الماء", "النيتروجين السائل", "الزيت", "الحليب"], correctAnswer: 2, category: "علوم" },
  { text: "ما هو لون الشمس الحقيقي من الفضاء؟", choices: ["أصفر", "برتقالي", "أبيض", "أحمر"], correctAnswer: 3, category: "علوم" },
  { text: "كم تستغرق أشعة الشمس للوصول للأرض؟", choices: ["ثانية", "دقيقة", "8 دقائق", "ساعة"], correctAnswer: 3, category: "علوم" },
  { text: "أي كوكب يدور عكس اتجاه باقي الكواكب؟", choices: ["المريخ", "الزهرة", "الأرض", "المشتري"], correctAnswer: 2, category: "علوم" },

  // ─── معلومات عامة – جديد ─────────────────────────────────────────────────
  { text: "كم عدد الخطوط في شعار أديداس؟", choices: ["خطين", "3 خطوط", "4 خطوط", "5 خطوط"], correctAnswer: 2, category: "معلومات عامة" },
  { text: "ما هي الفاكهة التي بذورها خارجها؟", choices: ["الكيوي", "الفراولة", "المانجو", "الرمان"], correctAnswer: 2, category: "معلومات عامة" },

  // ─── ثقافة عامة – جديد ───────────────────────────────────────────────────
  { text: "في أي بلد تم اختراع الآيس كريم لأول مرة؟", choices: ["إيطاليا", "فرنسا", "الصين", "أمريكا"], correctAnswer: 3, category: "ثقافة عامة" },

  // ─── جغرافيا – جديد ─────────────────────────────────────────────────────
  { text: "أي دولة لديها أكبر عدد من الجزر في العالم؟", choices: ["إندونيسيا", "الفلبين", "السويد", "اليونان"], correctAnswer: 3, category: "جغرافيا" },
];
